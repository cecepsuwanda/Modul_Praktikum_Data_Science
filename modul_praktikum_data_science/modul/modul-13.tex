...
\noindent CPMK-P4 menekankan komunikasi \textit{insight}: manajer tidak wajib membaca kode, tetapi wajib memahami bukti, tingkat keyakinan, dan rekomendasi tindakan.
...
Ringkasan eksekutif hendaknya mandiri: dalam satu layar, pembaca memahami alasan menggulir ke bagian metode atau lampiran. Pilih plot yang menyangga satu klaim utama, bukan memuat semua percobaan sekaligus.

\input{tikz/fig_story_arc}
...
\MulaiPenjelasanKode Heading Markdown (\texttt{\#\#}) memecah ``cerita'' analitik menjadi blok yang bisa diekspor ke slide atau PDF; urutan mengikuti alur CRISP-DM ringkas. \SelesaiPenjelasanKode
...
\MulaiPenjelasanKode Diagram batang membandingkan sedikit kategori (model) dengan satu metrik (F1); angka di sini hanya ilustrasi---ganti dengan metrik hasil validasi Anda. \SelesaiPenjelasanKode
...
\MulaiPenjelasanKode \texttt{savefig} menulis figur aktif ke disk; \texttt{dpi} mengontrol resolusi cetak/proyektor; \texttt{bbox\_inches="tight"} memangkas margin putih berlebih. \SelesaiPenjelasanKode
...
\MulaiPenjelasanKode \texttt{to\_markdown} menghasilkan tabel Markdown dari DataFrame---cocok untuk menempelkan ringkasan metrik ke README atau laporan tanpa mengetik tabel manual. \SelesaiPenjelasanKode
