...
\noindent Presentasi menutup siklus OBE: Anda menunjukkan kemampuan merangkum bukti kuantitatif menjadi narasi keputusan. Penilaian tidak hanya pada metrik tertinggi, melainkan pada kejelasan argumen dan pengakuan keterbatasan.
...
\noindent\textbf{Mengapa blok ini?} Struktur heading Markdown memetakan satu ide per slide: konteks data, bukti model, aksi bisnis---memudahkan audiens non-teknis mengikuti alur.
...
\noindent\textbf{Mengapa blok ini?} Menunjukkan pola \texttt{joblib.load} untuk membuka artefak model yang disimpan minggu lalu; baris aktif di bawah hanya placeholder agar sel tetap jalan tanpa berkas \texttt{.joblib}.
...
\noindent\textbf{Mengapa blok ini?} \texttt{os.path.getsize} memberi ukuran byte; dibagi 1024 untuk KB agar Anda memastikan unggahan di bawah batas portal pengumpulan.
