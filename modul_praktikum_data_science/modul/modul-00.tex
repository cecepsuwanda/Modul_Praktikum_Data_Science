...
Bab ini menjadi peta navigasi seluruh praktikum: Anda akan melihat bagaimana \textbf{Sub-CPMK P1--P10}, \textbf{CPMK-P1--P4}, dan \textbf{CPL prodi} dirangkai dalam 16 minggu. Memahami identitas MK membantu menyelaraskan ekspektasi dosen, asisten, dan mahasiswa terhadap bukti kinerja di notebook.
...
Modul ini mendukung \textbf{CPMK-P1--P4} dan \textbf{Sub-CPMK-P1--P10} untuk praktikum berbasis \textbf{OBE}. Lingkup: Python 3, \jupyter{} (atau Colab/VS Code), NumPy, Pandas, Matplotlib, Seaborn, \sklearn{}. Alur: pemahaman masalah (CRISP-DM), data, prapemrosesan, EDA, pemodelan, evaluasi, komunikasi \textit{insight}. RPS resmi: \path{silabus_praktikum_data_science.tex}.

Ruang lingkup disusun agar setiap minggu memiliki \textbf{keluaran konkret} di notebook: mulai dari etika dan struktur CRISP-DM, berlanjut ke manipulasi data, visualisasi, lalu pemodelan dengan metrik yang dapat diinterpretasikan. Pendekatan ini menjembatani teori Data Science dengan praktik reproduktif di laboratorium.
...
K3 laboratorium melindungi pengguna perangkat dan menjaga keberlangsungan praktikum multi-angkatan. Etika data memastikan penggunaan dataset sesuai lisensi dan norma privasi. Keduanya merupakan bagian tak terpisahkan dari capaian profesionalisme, bukan sekadar aturan administratif.
